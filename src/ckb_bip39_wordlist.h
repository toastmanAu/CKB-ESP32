/*
 * ckb_bip39_wordlist.h — BIP39 English wordlist (2048 words)
 *
 * Used for:
 *   1. Validating words during mnemonic entry
 *   2. Getting word index for checksum validation
 *
 * On ESP32 with PSRAM this is fine in RAM (~22KB).
 * Without PSRAM: store in flash with PROGMEM / put in .rodata.
 *
...
"material","math","matter","maximum","maze","meadow","mean","medal",
"media","melody","melt","member","memory","mention","mentor","merge",
"merit","merry","mesh","message","metal","method","middle","midnight",
"milk","million","mimic","mind","minimum","minor","minute","miracle",
"miss","mitten","model","modify","mom","monitor","monkey","monster",
...
"robust","rocket","romance","roof","rookie","round","route","royal",
...
"save","say","scale","scan","scatter","scene","scheme","scissors",
"scorpion","scout","scrap","screen","script","scrub","sea","search",
"season","seat","second","secret","section","security","seek","segment",
...
"shrug","shuffle","shy","sibling","siege","sight","sign","silent",
...
"thumb","thunder","ticket","tilt","timber","time","tiny","tip",
"tired","title","toast","tobacco","today","together","toilet","token",
"tomato","tomorrow","tone","tongue","tonight","tool","topic","topple",
...
static int bip39_word_index(const char *word) {
    for (int i = 0; i < 2048; i++) {
        if (strcmp(BIP39_WORDLIST_EN[i], word) == 0)
            return i;
    }
    return -1;
}
